...
for dir_path in ["docs/requirements", "docs/tasks", "tmp"]:
...
def get_file_content(file_path: str, default_content: str = "") -> str:
    ...
    full_path = os.path.join("docs", file_path)
    ensure_file_exists(full_path, default_content)
...
planner_agent = Agent(
    ...
    instructions=[
        ...
        "2. For each identified phase, create a task file in the tasks directory named '{phase}_tasks.txt'",
        "3. Organize tasks by these project-specific phases",
